...
của các tổ chức có tài nguyên tính toán khổng lồ.

Báo cáo này lấp điểm mù đó bằng cách làm ngược lại: \textbf{tự tiền huấn luyện
phần ngôn ngữ từ token đầu tiên}, ở quy mô mà một máy đơn xử lý được trong
...
\emph{SFT} $\rightarrow$ \emph{RL} ở quy mô một máy đơn.
...
\begin{enumerate}
	\item Tiền huấn luyện từ đầu một mô hình 101M tham số kiến trúc Llama-style
	      trên khoảng 3 tỷ token tiếng Việt, ở quy mô nhỏ, đạt được chất
...
Việt từ dữ liệu web thô đến VLM biết trả lời bằng tiếng Việt ở quy mô nhỏ;
