...
nhưng không ghi ma trận $T \times T$ ra bộ nhớ, giúp giảm mạnh chi phí bộ nhớ
khi độ dài chuỗi lớn.
...
--- tiền huấn luyện từ đầu 3,7B tham số trên hạ tầng tính toán lớn --- là mốc trên
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{lXccc}
		...
		PhoGPT-4B & tự pretrain (3,7B, hạ tầng lớn) & \checkmark & --- & --- \\
		nanoVLM & SmolLM2 huấn luyện sẵn & --- & \checkmark & --- \\
		LaVy / Vintern-1B & LLM tỷ tham số sẵn & \checkmark & \checkmark & --- \\
		\textbf{ViVLM-nano} & \textbf{tự pretrain (101M, quy mô nhỏ)} & \checkmark & \checkmark & \checkmark \\
		\hline
	\end{tabularx}
\end{table}
