...
9 giờ 41 phút trên một GPU), sau đó hợp nhất thị giác kiểu LLaVA (SigLIP đóng
băng, projector pixel-shuffle), tinh chỉnh có giám sát hai pha (CIDEr UIT-ViIC
0,325) và tinh chỉnh học tăng cường SCST (nâng CIDEr thêm 0,068) --- toàn bộ
trên đúng một GPU 24\,GB, với mức sử dụng GPU gần 100\% và VRAM 91\% suốt giai
đoạn tiền huấn luyện. Cùng đồ án giữa kỳ (nhánh phân loại) và đồ án cuối kỳ
